...
COUNTERS = Archetype(
    ...
    slots=[
        Slot("Counter Doublers & Payoffs", 16, cls.is_counter_payoff,
        ...
        Slot("Card Draw", 10, cls.is_draw, score_rank,
...
ARISTOCRATS = Archetype(
    ...
    slots=[
        Slot("Token Generators", 12, cls.is_token_maker, score_rank,
        ...
        Slot("Death Triggers / Drain", 10, cls.is_death_trigger, score_rank,
...
TRIBAL = Archetype(
    ...
    slots=[
        Slot("Tribal Payoffs & Lords", 14, cls.is_tribal_payoff,
             score_rank, "Tribal", "Lord o payoff tribal."),
        Slot("Creatures del mismo tipo", 10,
             lambda c: c.get("is_creature") and cmc(c) <= 4,
...
BLINK = Archetype(
    ...
    slots=[
        Slot("ETB Payoffs (criaturas con ETB fuerte)", 16, cls.is_blink_payoff,
...
LANDFALL = Archetype(
    ...
    slots=[
        Slot("Landfall Payoffs", 14, cls.is_landfall_payoff,
             score_rank, "Landfall", "Trigger o payoff de landfall."),
        Slot("Land Ramp (fetch extra lands)", 12, cls.is_ramp,
...
LIFEGAIN = Archetype(
    ...
    slots=[
        Slot("Lifegain Payoffs", 14, cls.is_lifegain_payoff,
             score_rank, "Lifegain Payoff", "Premia ganar vida."),
        Slot("Lifegain Sources", 10,
...
REANIMATOR = Archetype(
    ...
    slots=[
        Slot("Reanimation Spells", 10, cls.is_recursion,
             score_low_cmc_then_rank, "Reanimate", "Devuelve cartas del cementerio."),
        Slot("Enablers (discard / mill)", 8,
        ...
        Slot("Reanimator Targets (criaturas 6+)", 10, cls.is_reanimator_payoff,
